...
public class LetraSequencialTest {
	...
	@Test
	public void verificaLetraSequencial() {

		Pontuacao p = passwordService.verifica(senha);

		assertEquals(0, p.getQuantLetraSequencial());
	}

	@Test
	public void verificaBonusLetraSequencial() {

		Pontuacao p = passwordService.verifica(senha);

		assertEquals(0, p.getValorLetraSequencial());
	}

...
public class ApenasNumeroTest {
	...
	@Test
	public void verificaApenasNumero() {

		Pontuacao p = passwordService.verifica(senha);

		assertEquals(0, p.getQuantApenasNumero());
	}

	@Test
	public void verificaBonusApenasNumero() {

		Pontuacao p = passwordService.verifica(senha);

		assertEquals(0, p.getValorApenasNumero());
	}
